  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "mangga-muda-1": "url('/assets/img/landing-mangga-muda-1.png')",
        "mangga-muda-2": "url('/assets/img/landing-mangga-muda-2.png')",
        "mangga-muda-3": "url('/assets/img/landing-mangga-muda-3.png')",
        "mangga-muda-4": "url('/assets/img/landing-mangga-muda-4.png')",
