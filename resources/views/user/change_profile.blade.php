            ...
            <form action="{{ route('user.update', Auth::id()) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-12 gap-x-4 card px-6 py-8">
                    <div class="col-span-6 flex flex-col">
                        ...
                        <input name="ktp_code" type="number" class="form-input bg-white mb-4" required pattern=".{16,16}"
                            value="{{ Auth::user()->ktp_code }}">
                        <label class="text-gray-400">No. KK</label>
                        <input name="kk_code" type="number" class="form-input bg-white mb-4" required pattern=".{16,16}"
