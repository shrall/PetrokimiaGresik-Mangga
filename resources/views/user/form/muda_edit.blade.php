...
@section('content')
    <form action="{{ route('user.muda.update', $muda->id) }}" method="post" enctype="multipart/form-data"
        id="form-mangga-muda">
        @csrf
        @method('PATCH')
        ...
        <div class="grid-cols-2 gap-x-8 gap-y-2 form-step hidden" id="data-usaha-2">
            ...
            <div class="col-span-2">
                <textarea name="needs" id="" cols="30" rows="7" class="form-pengajuan-input"
                    placeholder="Kebutuhan dan Sumber Daya*" required>{{ $muda->needs }}</textarea>
            </div>
            <div class="col-span-2">
        ...
        <div class="grid-cols-2 gap-x-8 form-step hidden" id="arus-kas-9">
            ...
            <div class="">
                ...
                <input type="number" name="outflow_admin[4]" value="{{ $muda->reports[3]->outflow_admin }}"
                    class="form-pengajuan-input" placeholder="Biaya Administrasi Lain-lain*" required>
                <input type="number" name="outflow_installments[4]" value="{{ $muda->reports[3]->outflow_installments }}"
                    class="form-pengajuan-input" placeholder="Angsuran Pokok*" required>
        ...
        <div class="grid-cols-2 gap-x-8 form-step hidden" id="arus-kas-10">
            <div class="">
                ...
                <input type="number" name="outflow_admin[5]" value="{{ $muda->reports[4]->outflow_admin }}"
                    class="form-pengajuan-input" placeholder="Biaya Administrasi Lain-lain*" required>
                <input type="number" name="outflow_installments[5]" value="{{ $muda->reports[4]->outflow_installments }}"
                    class="form-pengajuan-input" placeholder="Angsuran Pokok*" required>
            ...
            <div class="">
                ...
                <input type="number" name="outflow_admin[6]" value="{{ $muda->reports[5]->outflow_admin }}"
                    class="form-pengajuan-input" placeholder="Biaya Administrasi Lain-lain*" required>
                <input type="number" name="outflow_installments[6]" value="{{ $muda->reports[5]->outflow_installments }}"
                    class="form-pengajuan-input" placeholder="Angsuran Pokok*" required>
