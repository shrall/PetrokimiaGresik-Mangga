<div class="flex flex-col h-vh-90 gap-y-6 px-8 text-xl">
    @if (Route::current()->getName() == 'user.user.index')
        <a href="{{ route('user.user.index') }}" class="bg-mangga-green-300 text-white rounded-lg p-3">
            <span class="fa fa-fw fa-user mr-2"></span>Profil
        </a>
    @else
        <a href="{{ route('user.user.index') }}" class="hover:bg-mangga-green-300 hover:text-white rounded-lg p-3">
            <span class="fa fa-fw fa-user mr-2"></span>Profil
        </a>
    @endif
    @if (Route::current()->getName() == 'user.user.ajuan')
    ...
    @endif
    @if (Route::current()->getName() == 'user.user.riwayat_angsuran')
        <a href="#" class="bg-mangga-green-300 text-white rounded-lg p-3">
    ...
    @endif
    @if (Route::current()->getName() == 'user.user.belanja')
        <a href="#" class="bg-mangga-green-300 text-white rounded-lg p-3">
