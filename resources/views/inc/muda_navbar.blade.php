...
<div class="items-center gap-x-4 font-os px-8 py-4 bg-light-200 text-lg hidden xl:grid grid-cols-12" id="navbar-desktop">
    ...
    @guest
        <div class="flex items-center justify-end gap-x-2 col-span-3">
            <a href="{{ route('mangga_muda.login') }}" class="mangga-button-green-outline">Masuk</a>
            <a href="{{ route('mangga_muda.register') }}" class="mangga-button-orange">Daftar</a>
        </div>
    @endguest
    @auth
...
<div class="font-os px-8 py-4 bg-light-200 text-lg block xl:hidden" id="navbar-mobile">
    ...
    <div class="hidden flex-col gap-y-8 font-medium" id="navbar-menu-mobile">
        <a href="{{ route('mangga_muda.login') }}"
