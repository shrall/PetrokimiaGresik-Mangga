...
@section('content')
    <div class="grid grid-cols-10 gap-x-8 mx-8">
        ...
        <div class="col-span-7 2xl:col-span-8 flex flex-col gap-y-4 py-4 px-8">
            <div class="text-6xl font-af text-mangga-green-400 mb-4">Program Mangga Madu</div>
            ...
            <div class="text-6xl font-af text-mangga-green-400 text-center mb-4">Persyaratan Mangga Madu</div>
