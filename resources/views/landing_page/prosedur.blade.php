...
@section('content')
    ...
    <div class="hidden md:block">
        <div
            ...
            <div class="col-span-7 xl:col-span-6 border border-gray-400 bg-white">
        ...
        <div
            class="grid grid-cols-12 items-center justify center mx-20 xl:mx-52 bg-prosedur-3 bg-contain bg-no-repeat bg-left h-vh-80 ">
            <div class="col-span-5"></div>
            <div class="col-span-7 xl:col-span-6 border border-gray-400 bg-white">
                <img src="{{ asset('assets/img/mangga-arumanis.png') }}">
                <div class="text-2xl px-12 mb-4">“Mangga Arumanis” asuransi maksimal untuk pertanian strategis. Program
                    literasi
                ...
                <div class="text-2xl px-12 mb-12">
                    <ul>
                        ...
                        <li><span class="fa fa-fw fa-leaf text-mangga-green-400"></span>rantuan Asuransi Usaha Tani Padi
                            (AUTP)
                        </li>
                    </ul>
                </div>
        ...
        <div
            class="grid grid-cols-12 items-center justify center mx-20 xl:mx-52 bg-prosedur-4 bg-contain bg-no-repeat bg-right h-vh-80">
            <div class="col-span-7 border border-gray-400 bg-white">
                ...
                <div class="text-3xl font-bold px-12 mb-12">Program pembiayaan yang dikhususkan bagi petani atau pekebun
                    yang
    ...
    <div class="block md:hidden">
        <img src="{{asset('assets/img/asset-prosedur-2.png')}}" class="px-4">
        <img src="{{ asset('assets/img/mangga-gadung.png') }}">
        <div class="text-xl px-12 mb-4">“Mangga Gadung” Mitra Kebanggaan - Pedagang Unggul, Program pembiayaan dan
            literasi keuangan bagi pedangang pupuk dengan benefit:</div>
        <div class="text-xl font-bold px-12 mb-4">DAPATKAN FASILITAS PINJAMAN</div>
        ...
        <img src="{{asset('assets/img/asset-prosedur-3.png')}}" class="px-4">
        <img src="{{ asset('assets/img/mangga-arumanis.png') }}">
        <div class="text-xl px-12 mb-4">“Mangga Arumanis” asuransi maksimal untuk pertanian strategis. Program
            literasi
            Asuransi Usaha Tani Padi (AUTP) bagi petani binaan PT Petrokimia Gresik dengan benefit:</div>
        <div class="text-xl font-bold px-12 mb-4">DAPATKAN FASILITAS PINJAMAN</div>
        <div class="text-xl px-12 mb-12">
        ...
        <img src="{{asset('assets/img/asset-prosedur-4.png')}}" class="px-4">
        <img src="{{ asset('assets/img/mangga-makmur.png') }}">
        <div class="text-xl px-12 mb-4">Program Mangga Makmur adalah program pertanian terpadu yang diinisiasi oleh
            Pupuk lndonesia dan PUMK merupakan bagian kecil dari integrasi program tersebut.</div>
        <div class="text-2xl font-bold px-12 mb-12">Program pembiayaan yang dikhususkan bagi petani atau pekebun
            yang
            tergabung pada program pertanian terpadu “<span class="text-mangga-green-400">MAKMUR</span>”
        </div>
    </div>
