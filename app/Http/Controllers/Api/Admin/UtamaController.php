...
class UtamaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $return = [
            'api_code' => 200,
            'api_status' => true,
            'api_message' => 'Pengajuan Mangga Utama berhasil disimpan.',
    ...
    public function update(Request $request, Utama $utama)
    {
        ...
        $return = [
            'api_code' => 200,
            'api_status' => true,
            'api_message' => 'Pengajuan Mangga Utama berhasil diperbarui.',
            'api_results' => UtamaResource::make($utama)
        ];
        return SuccessResource::make($return);
    }
    ...
    public function destroy(Utama $utama)
    {
        $return = [
            'api_code' => 200,
            'api_status' => true,
            'api_message' => 'Pengajuan Mangga Utama berhasil dihapus.',
            'api_results' => UtamaResource::make($utama)
        ];
        $utama->business->delete();
        return SuccessResource::make($return);
    }
    ...
    public function ttd(Request $request, Utama $utama)
    {
        ...
        $return = [
            'api_code' => 200,
            'api_status' => true,
            'api_message' => 'Sukses mengupload file.',
            'api_results' => UtamaResource::make($utama)
        ];
        return SuccessResource::make($return);
    }

    public function approve(Utama $utama)
    {
        ...
        $return = [
            'api_code' => 200,
            'api_status' => true,
            'api_message' => 'Pengajuan Mangga Utama berhasil disetujui.',
            'api_results' => UtamaResource::make($utama)
        ];
        return SuccessResource::make($return);
    }
    ...
    public function reject(Utama $utama)
    {
        ...
        $return = [
            'api_code' => 200,
            'api_status' => true,
            'api_message' => 'Pengajuan Mangga Utama berhasil ditolak.',
            'api_results' => UtamaResource::make($utama)
        ];
        return SuccessResource::make($return);
    }
